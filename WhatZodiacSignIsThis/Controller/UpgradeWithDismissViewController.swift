//
//  UpgradeWithDismissViewController.swift
//  WhatZodiacSignIsThis
//
//  Created by MyMac on 10/15/23.
//
...
class UpgradeWithDismissViewController: UIViewController {
    ...
    // Check to see if this is a premium user before appearing
