...
class GamePlayTwoViewController: UIViewController {
    ...
    @IBAction func ballonPressed(_ sender: UIButton) {
        ...
        GameSetupManager.shared.ballonHelper(numOfIncorrectAnswersToRemove: 4, answerButtons: answerButtons, scoreLabelText: scoreLabel, smallOrRegCorrectSignKeyFromJokesArray: smallCorrectSignKeyFromJokesArray, scoreLabelIntFromVC: scoreLabelInt)
