...
struct PromoJokes {
    ...
    static let shared = PromoJokes()
    
    let promoJokes = [
       
//        "PiscesButton": [
//
//            //"I don't procrastinate. I wait until the last minute to do things because I will be older and wiser.",
...
//        "TaurusButton": [
//
//            "If I finish washing dishes & forget one behind I'm throwing it out.",
//
//            //"If I run an errand, that is considered going out..argue with ur mama."
//        ],
        "GeminiButton": [
           
            "Calling me a liar when I took my time to make up the story makes me soo mad!",
        ...
        "VirgoButton": [
            "\"Wrong girl” really irritates me. An Organized man like myself would never mix up my woman.",
...
//            "I TALK IN ALL CAPS!!!",
//            "I beep the horn loud af outside my sneaky links house for excitement.",
//            "I hate it when I'm singing a song & the artist gets the words wrong."
        ],
//        "AquariusButton": [
//            "Dont you dare tell me 'NOT TODAY'!! I will instantly start imagining life without u.",
//
////            "Thanks to buy now, pay later I now basically have another car payment.",
////            "Now..let me find the perfect song to cry to.",
////            "Nothing hurts more than when u send a meme to someone and they already seen it."
//        ]
    ]
...
//            "Nothing hurts more than when u send a meme to someone and they already seen it."
    ...
    let promoJokes2 = [
        ...
        "PiscesButton": [
            "I can't believe u canceled plans that I never intended on showing up to.",
        ...
        "AriesButton": [
            "I get drunk and start buying drinks for total strangers.",
            "Dumb things irritate me like people clapping when the plane lands.",
            "Once she falls in love, I fall out of character..and CUT!",
            "Patience shorter than ur gf's ponytail.",
...
//            "It takes me .001 sec to pick out my clothes for the day..I truly dgaf."
        ...
        "TaurusButton": [
            ...
            //"U got IG? NO...FB? NO, What's ur name? NO",
...
//            "I'm not a person u should put on speakerphone."
        ...
        "CancerButton": [
            "I’m not mad, u just need to stop breathing that is all.",
            "I will never date someone who thinks going to Miami is 'well-traveled'.",
            "People be like u need to get a bigger tv..How about u get ur own place to live.",
            "I be bored when my man with his wife at home.",
//            "I can't argue with someone who can't keep track of their birth certificate.",
//            "Friends talking about 'leave him alone'..I will leave YALL alone TF."
        ],
        "LeoButton": [
            "So..am I the only girl you're talking to? ME: yeh, everyone is asleep already.",
...
//            "I once brought my tv remote to school thinking it was my calculator.",
//            "When u get into a heated argument, realize u're wrong & now u initiate the break up."
        ...
        "LibraButton": [
            ...
            "If he cheating, cheat back. Support ur man in everything he does.",
            "If we break up, I do not wish u well. I hope u get chased by hyenas.",
            "It still bothers me to this day that I didn't cheat on my ex.",
            "I need to control ur life so this relationship can work.",
            "This would have never happened if u never caught me cheating."
        ],
//        "ScorpioButton": [
//            "I don't go on 2nd dates..There be a flaw I might miss.",
//            "Cute until I feel like u're gonna leave me then BOOM u ruined my life",
...
//            "I hate it when I'm singing a song & the artist gets the words wrong."
        ...
        "AquariusButton": [
            "When u tell her 'NOT TODAY' & she instantly starts imagining life without u.",
